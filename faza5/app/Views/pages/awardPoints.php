...
<div id="short-main">
    ...
    <form name='awardUser' action="<?= site_url("User/awardUserSubmit/{$awardee->id}") ?>" method="POST">
        <span style="font-size: 25px; vertical-align: middle;">Award points to <br> <img style="width: 30px; vertical-align: middle;" src="<?php echo (new UserM())->getAvatar($awardee->id) ?>" /> <?php echo $awardee->nickname ?>.</span>
